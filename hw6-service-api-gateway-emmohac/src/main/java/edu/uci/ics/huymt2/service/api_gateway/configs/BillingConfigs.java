package edu.uci.ics.huymt2.service.api_gateway.configs;
...
public class BillingConfigs {
    ...
    public BillingConfigs(ConfigsModel cm) throws NullPointerException {
        ...
        if (EPCartInsert == null)
            ServiceLogger.LOGGER.info("No path for endpoint /api/billing/cart/insert found.");
        else
            ServiceLogger.LOGGER.info("[Billing][EP] Insert Cart: "+ EPCartInsert);
