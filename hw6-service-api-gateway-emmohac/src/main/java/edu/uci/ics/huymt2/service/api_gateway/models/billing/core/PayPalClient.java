...
public class PayPalClient {
    ...
    public Map<String, Object> createdPayment(String sum){
        ...
        String scheme = GatewayService.getBillingConfigs().getScheme();     //BillingService.getConfigs().getScheme();
        String hostName = GatewayService.getBillingConfigs().getHostName(); //BillingService.getConfigs().getHostName();
        int port = GatewayService.getBillingConfigs().getPort();            //BillingService.getConfigs().getPort();
        String path = GatewayService.getBillingConfigs().getPath();         //BillingService.getConfigs().getPath();
