package edu.uci.ics.huymt2.service.api_gateway;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.huymt2.service.api_gateway.configs.*;
import edu.uci.ics.huymt2.service.api_gateway.connectionpool.ConnectionPool;
import edu.uci.ics.huymt2.service.api_gateway.configs.*;
import edu.uci.ics.huymt2.service.api_gateway.configs.*;
import edu.uci.ics.huymt2.service.api_gateway.logger.ServiceLogger;
import edu.uci.ics.huymt2.service.api_gateway.threadpool.ThreadPool;
...
public class GatewayService {
    ...
    private void initConnectionPool() {
        ...
        conPool = new ConnectionPool(gatewayConfigs.getNumThreads(),
                gatewayConfigs.getDbDriver(),
                gatewayConfigs.getDbUrl(),
                gatewayConfigs.getDbUsername(),
                gatewayConfigs.getDbPassword());
        ServiceLogger.LOGGER.config("Connection pool initialized.");
    }
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.huymt2.service.api_gateway.resources");
