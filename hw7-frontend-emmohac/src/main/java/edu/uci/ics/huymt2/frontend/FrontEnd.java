package edu.uci.ics.huymt2.frontend;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.huymt2.frontend.configs.Configs;
import edu.uci.ics.huymt2.frontend.logger.ServiceLogger;
import edu.uci.ics.huymt2.frontend.models.ConfigsModel;
...
public class FrontEnd {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.huymt2.service.idm.resources");
